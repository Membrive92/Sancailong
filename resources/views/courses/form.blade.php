...
@section('content')
    <div class="pl-5 pr-5">
        <!-- Desde el formulario controlo csi se va a crear o actualizar un curso -->
        <form
                method="POST"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <!-- Para recoger los datos de la base de datos y controlar si esta actualizando o creando tengo este codigo
                                    primero compruebo si se ha enviado algo previamente con la funcion old  sino hago un count y si su valor es superior a 0 , saco el de la posicion 0 del array-->
                                    <input
                                            id="requirement1"
                                ...
                                <!--Con este campo oculto controlo que el requisito 1 existe para que no se deje en blanco si pongo el 2 requisito antes que el primero
                                 -->
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <!-- Para recoger los datos de la base de datos y controlar si esta actualizando o creando tengo este codigo
                                      primero compruebo si se ha enviado algo previamente con la funcion old  sino hago un count y si su valor es superior a 1 , saco el de la posicion 1 del array-->
                                    <input
                                            id="requirement2"
                                ...
                                <!--Con este campo oculto controlo que el requisito 2 existe por si en un futuro ampliara mas requisitos
                                                                -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <!-- sigo la misma logica que con los requisitos-->
                                    <input
                                            id="goal1"
                                ...
                                <!-- La misma logica que en los requisitos -->
                        ...
                        <div class="card-body">
                            <div class="form-group row mb-0">
                                <div class="col-md-4 offset-5">
                                    <button type="submit" name="revision" class="btn btn-dark text-warning">
                                        {{ __($btnText) }}
                                    </button>
                                </div>
                            </div>
